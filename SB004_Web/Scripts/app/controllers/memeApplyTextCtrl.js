...
(function() {
	...
	var memeApplyTextCtrl = function($scope, $location,$rootScope,$timeout,$window, dialog, sharedDataService) {
  ...
  app.controller('memeApplyTextCtrl', ["$scope","$location","$rootScope","$timeout","$window", "dialog", "sharedDataService", memeApplyTextCtrl]);
